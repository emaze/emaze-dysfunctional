 ...
 * first parameter passed to the adapted function.
 *
...
public class IgnoreFirst<T1, T2, R> implements BiFunction<T1, T2, R> {
    ...
    public IgnoreFirst(Function<T2, R> adaptee) {
        dbc.precondition(adaptee != null, "cannot ignore first parameter of a null function");
