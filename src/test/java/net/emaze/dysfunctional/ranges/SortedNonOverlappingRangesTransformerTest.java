...
public class SortedNonOverlappingRangesTransformerTest {
    ...
    public void canMergeTwoContiguousNonOverlappingRanges() {
        ...
        final List<DenseRange<Integer>> got = new SortedNonOverlappingNonEmptyRangesTransformer<Integer>(RangeMother.sequencer, RangeMother.comparator).perform(Arrays.asList(a, b));
    ...
    public void callingErasureWithWrongTypeYieldsException() {
        Delegate d = new SortedNonOverlappingNonEmptyRangesTransformer<Integer>(RangeMother.sequencer, RangeMother.comparator);
