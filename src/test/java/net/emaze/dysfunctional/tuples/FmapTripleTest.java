...
public class FmapTripleTest {
    ...
    public void firstDelegateTransformsFirstType() {
        ...
        Triple<O, O, O> got = new FmapTriple<O, O, O, O, O, O>(function, ID, ID).apply(Triple.of(O.ONE, O.ONE, O.ONE));
    ...
    public void secondDelegateTransformsSecondType() {
        final Function<O, O> function = new ConstantFunction<O, O>(O.ANOTHER);
        final Triple<O, O, O> got = new FmapTriple<O, O, O, O, O, O>(ID, function, ID).apply(Triple.of(O.ONE, O.ONE, O.ONE));
    ...
    public void thirdDelegateTransformsThirdType() {
        final Function<O, O> function = new ConstantFunction<O, O>(O.ANOTHER);
        final Triple<O, O, O> got = new FmapTriple<O, O, O, O, O, O>(ID, ID, function).apply(Triple.of(O.ONE, O.ONE, O.ONE));
