 ...
 * @author rferranti
 */
public class TernaryCapturingFunctionTest {

    @Test(expected = IllegalArgumentException.class)
    public void wrappingNullDelegateYieldsException() {
        new TernaryCapturingFunction<O, O, O, O>(null, Box.<O>empty(), Box.<O>empty(), Box.<O>empty(), Box.<O>empty());
    }

    @Test(expected = IllegalArgumentException.class)
    public void passingNullBoxForResultYieldsException() {
        new TernaryCapturingFunction<O, O, O, O>(new FirstParamOfThree<O, O, O>(), null, Box.<O>empty(), Box.<O>empty(), Box.<O>empty());
    }

    @Test(expected = IllegalArgumentException.class)
    public void passingNullBoxForFirstParamYieldsException() {
        new TernaryCapturingFunction<O, O, O, O>(new FirstParamOfThree<O, O, O>(), Box.<O>empty(), null, Box.<O>empty(), Box.<O>empty());
    }

    @Test(expected = IllegalArgumentException.class)
    public void passingNullBoxForSecondParamYieldsException() {
        new TernaryCapturingFunction<O, O, O, O>(new FirstParamOfThree<O, O, O>(), Box.<O>empty(), Box.<O>empty(), null, Box.<O>empty());
    }

    @Test(expected = IllegalArgumentException.class)
    public void passingNullBoxForThirdParamYieldsException() {
        new TernaryCapturingFunction<O, O, O, O>(new FirstParamOfThree<O, O, O>(), Box.<O>empty(), Box.<O>empty(), Box.<O>empty(), null);
    }
    ...
    public void resultIsCaptured() {
        ...
        final TriFunction<O, O, O, O> delelgate = new TernaryCapturingFunction<O, O, O, O>(new FirstParamOfThree<O, O, O>(), result, param1, param2, param3);
