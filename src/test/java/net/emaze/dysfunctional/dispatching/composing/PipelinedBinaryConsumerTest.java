 ...
 * @author rferranti
 */
public class PipelinedBinaryConsumerTest {

    @Test(expected = IllegalArgumentException.class)
    public void creatingWithNullIterableYieldsException() {
        new PipelinedBinaryConsumer<String, String>(null);
    }
    ...
    public void actionsAreCalledInOrder() {
        ...
        final PipelinedBinaryConsumer<String, String> pipeline = new PipelinedBinaryConsumer<String, String>(actions);
