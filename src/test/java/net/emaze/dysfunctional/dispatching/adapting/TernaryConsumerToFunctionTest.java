 ...
 * @author rferranti
 */
public class TernaryConsumerToFunctionTest {

    @Test(expected = IllegalArgumentException.class)
    public void adaptingNullActionYieldsException() {
        new TernaryConsumerToFunction<O, O, O>(null);
    }

    @Test
    public void callingAdapterCallsAdapted() {
        final AtomicLong calls = new AtomicLong();
        final TriConsumer<O, O, O> monitor = Spies.monitor(new TernaryNoop<O, O, O>(), calls);
        final TriFunction<O, O, O, Void> function = new TernaryConsumerToFunction<>(monitor);
        function.apply(O.ONE, O.ANOTHER, O.YET_ANOTHER);
    ...
    public void firstParamIsForwardedToAdaptedAction() {
        ...
        final TriConsumer<O, O, O> monitor = Spies.spy1st(new TernaryNoop<O, O, O>(), param1);
        final TriFunction<O, O, O, Void> function = new TernaryConsumerToFunction<>(monitor);
        function.apply(O.ONE, O.ANOTHER, O.YET_ANOTHER);
    ...
    public void secondParamIsForwardedToAdaptedAction() {
        ...
        final TriConsumer<O, O, O> monitor = Spies.spy2nd(new TernaryNoop<O, O, O>(), param2);
        final TriFunction<O, O, O, Void> function = new TernaryConsumerToFunction<>(monitor);
        function.apply(O.ONE, O.ANOTHER, O.YET_ANOTHER);
    ...
    public void thirdParamIsForwardedToAdaptedAction() {
        ...
        final TriConsumer<O, O, O> monitor = Spies.spy3rd(new TernaryNoop<O, O, O>(), param3);
        final TriFunction<O, O, O, Void> function = new TernaryConsumerToFunction<>(monitor);
        function.apply(O.ONE, O.ANOTHER, O.YET_ANOTHER);
