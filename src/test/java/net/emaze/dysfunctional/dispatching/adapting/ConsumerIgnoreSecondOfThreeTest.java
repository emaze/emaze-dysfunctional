 ...
 * @author rferranti
 */
public class ConsumerIgnoreSecondOfThreeTest {

    @Test(expected = IllegalArgumentException.class)
    public void adaptingNullActionYieldsException() {
        new ConsumerIgnoreSecondOfThree<O, O, O>(null);
    }
    ...
    public void canIgnoreFirstParameter() {
        ...
        final ConsumerIgnoreSecondOfThree<O, O, O> adapted = new ConsumerIgnoreSecondOfThree<O, O, O>(spy);
