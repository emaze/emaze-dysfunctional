 ...
 * @author rferranti
 */
public class TernaryFunctionToPredicateTest {

    @Test(expected = IllegalArgumentException.class)
    public void adaptingNullYieldsException() {
        new TernaryFunctionToPredicate<O, O, O>(null);
    }
    ...
    public void adapterCorrectlyPassesFirstParamToAdapted() {
        ...
        final TriPredicate<O, Boolean, O> adapted = new TernaryFunctionToPredicate<>(spy);
    ...
    public void adapterCorrectlyPassesSecondParamToAdapted() {
        ...
        final TriPredicate<Boolean, O, O> adapted = new TernaryFunctionToPredicate<>(spy);
