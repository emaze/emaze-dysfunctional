...
public class OptionalToEitherTest {
    ...
    public void callingOnNullMaybeYieldsException() {
        new OptionalToEither<O, O>(new ConstantSupplier<O>(O.ANOTHER)).apply(null);
    }

    @Test
    public void transformingNothingYieldsLeft() {
        final Function<Optional<O>, Either<O, O>> maybeToEither = new OptionalToEither<O, O>(new ConstantSupplier<O>(O.ANOTHER));
